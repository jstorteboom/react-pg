...
import { ChatBox, ChatInterface } from './ChatInterface';
import { useBoolean } from '@fluentui/react-hooks';

export const ZeroDriveUI = (props: any) => {
  // Component styles
  ...
  const [isChatPanelOpen, { setTrue: openChatPanel, setFalse: dismissChatPanel }] = useBoolean(false);
  const [isAppMenuOpen, { setTrue: openAppMenuPanel, setFalse: dismissAppMenuPanel }] = useBoolean(false);
    ...
    <Stack styles={containerStackStyles}>
      ...
      <Stack horizontal>
        <Panel
            ...
            onDismiss={dismissAppMenuPanel}
            type={PanelType.smallFixedNear}
            isBlocking={false}
            closeButtonAriaLabel="Close"
            headerText="My Applications"
        >
            <p>
            These are the applications you have access to:
            </p>
            <p>
                <ul>
                    <li>IoP</li>
        ...
        <Panel
            ...
            closeButtonAriaLabel="Close"
            headerText="My Messages"
        >
            <p>
            This is some example chat interface:
            </p>
...
//   };
  ...
  for (let i = 1; i <= 50; i++) {
    ...
    const folderIcon: IIconProps = { iconName: 'Folder' };

    const button: JSX.Element = (
      <div>
        <CommandButton iconProps={folderIcon} text="Folder Item" />
      </div>
    );
